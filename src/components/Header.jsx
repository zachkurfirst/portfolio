const Header = (props) => {
  return (
    <header className="flex justify-between sm:text-xl text-sm py-4 bg-sky-800 dark:bg-sky-950 text-slate-100 dark:border-b dark:border-slate-100 uppercase fixed top-0 left-0 right-0 backdrop-blur">
